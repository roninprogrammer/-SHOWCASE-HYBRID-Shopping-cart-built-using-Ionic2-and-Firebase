var Logger = (function () {
    ...
    return {
        ...
        debug: function (message, obj) {
            log(Config.Level.DEBUG, message, obj);
        },
        info: function (message, obj) {
            log(Config.Level.INFO, message, obj);
        },
        warn: function (message, obj) {
            log(Config.Level.WARN, message, obj);
        },
        error: function (message, obj) {
            log(Config.Level.ERROR, message, obj);
        },
        enable: function () {
            activated = true;
        },
    ...
    function checkExist(value, obj) {
        ...
        console.warn('Unknown value <' + value + '>, available: ' + JSON.stringify(obj));
        return false;
    }
